...
LOCAL fci_u8 fc8050_get_SNR(void)
{
  fci_u16 ber;
  fci_u16 rssi;
  ...
  if((ber < 50)||(rssi < 5)) return 20;
  else if((ber < 100)||(rssi < 10)) return 19;
  else if((ber < 150)||(rssi < 15)) return 18;
  else if((ber < 200)||(rssi < 20)) return 17;
  else if((ber < 250)||(rssi < 25)) return 16;
  else if((ber < 300)||(rssi < 30)) return 15;
  else if((ber < 350)||(rssi < 35)) return 14;
  else if((ber < 400)||(rssi < 40)) return 13;
  else if((ber < 450)||(rssi < 45)) return 12;
  else if((ber < 500)||(rssi < 50)) return 11;
  else if((ber < 550)||(rssi < 55)) return 10;
  else if((ber < 600)||(rssi < 60)) return 9;
  else if((ber < 700)||(rssi < 65)) return 8;
  else if((ber < 800)||(rssi < 70)) return 7;
  else if((ber < 900)||(rssi < 75)) return 6;
  else if((ber < 1000)||(rssi < 80)) return 5;
  else if((ber < 1100)||(rssi < 85)) return 4;
  else if((ber < 1200)||(rssi < 90)) return 3;
  else if((ber < 1300)||(rssi < 95)) return 2;
  else if((ber < 1400)||(rssi < 100)) return 1;
  else return 0;
