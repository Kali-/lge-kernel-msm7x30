...
#ifdef BMA250_DEBUG
	printk(KERN_INFO "bma250_set_accelerometer(%d), sensor_enable: %02x\n", enable, data->sensor_enable);
#endif
	return 0;
}
...
#ifdef BMA250_DEBUG
	printk(KERN_INFO "bma250_set_gesture(%d), sensor_enable: %2x\n", enable,data->sensor_enable);
#endif
	return 0;
}
...
#ifdef BMA250_DEBUG
	printk(KERN_INFO "bma250_set_calibration(%d), sensor_enable: %2x\n", enable,data->sensor_enable);
#endif
	return 0;
}
